                ...
                <DialogTrigger>
                    <Card className="w-[250px] h-[300px] border-dashed grid place-content-center">
                        <CardHeader className="text-center">
                            <CardTitle className="text-lg">Add Intervenants for your Formation</CardTitle>
                    ...
                    <DialogHeader>
                        ...
                        <div className="flex gap-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Input type="password" placeholder="password" className="w-72 p-2 border border-gray-300 rounded-md" value={phone} onChange={(e) => setPhone(e.target.value)} />
                            </div>
                            <div className="flex gap-3">
