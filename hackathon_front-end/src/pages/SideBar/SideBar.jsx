        ...
        <div className="p-2 pb-4 flex justify-between items-center">
          <h1
            className={`overflow-hidden transition-all ${
              expanded ? "w-32 text-2xl font-bold text-black" : "w-0"
            }`}
            style={{ lineHeight: "50px" }}
          >
            Forma<span className="text-[#7b7b7b] ">tion</span>
            {/* <img src="/photos/logo.png" className="w-44"/> */}

          </h1>
          <button onClick={toggleExpanded} className="menu-btn bg-[#7b7b7b]">
  ...
  return (
    <li
      ...
      className={`relative flex ${
        ...
        isItemSelected ? "bg-[#7b7b7b] text-white" : "bg-transparent text-black"
